...
core_tags_metadata = [
    ...
    {"name": "templates", "description": "**TRE admin** can perform administrative tasks on templates"},
]
...
core_router.include_router(templates.templates_router, tags=["templates"])
