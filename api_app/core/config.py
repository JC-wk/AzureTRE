...
SERVICE_BUS_MESSAGES_STORAGE_ACCOUNT_NAME: str = config("SERVICE_BUS_MESSAGES_STORAGE_ACCOUNT_NAME", default="")
SERVICE_BUS_MESSAGES_CONTAINER_NAME: str = config("SERVICE_BUS_MESSAGES_CONTAINER_NAME", default="sb-messages")
SERVICE_BUS_MESSAGE_OFFLOAD_THRESHOLD: int = config("SERVICE_BUS_MESSAGE_OFFLOAD_THRESHOLD", cast=int, default=200000)  # 200KB
