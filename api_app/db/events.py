...
async def bootstrap_database() -> bool:
    try:
        ...
        await asyncio.gather(
            ...
            create_container_if_not_exists(db_mgmt_client, STATE_STORE_WORKSPACE_ADDRESS_ALLOCATIONS_CONTAINER, "/workspaceId")
        )
