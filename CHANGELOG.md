...
ENHANCEMENTS:
* Add durable workspace address allocation lifecycle tracking to prevent address reuse until release is confirmed. ([#4727](https://github.com/microsoft/AzureTRE/issues/4727))
