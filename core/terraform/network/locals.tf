locals {
  ...
  # FREE = local.core_services_vnet_subnets[10] # .64 - .127
  # FREE = local.core_services_vnet_subnets[11] # .128 - .191
  # FREE = local.core_services_vnet_subnets[12] # .192 - .254

  # New VNets address spaces
  firewall_vnet_address_space = "10.2.0.0/22"
  bastion_vnet_address_space  = "10.3.0.0/22"
  appgw_vnet_address_space    = "10.4.0.0/22"
