...
| `SERVICE_BUS_SKU` | Optional. The SKU of the Service Bus namespace. Default value is `Premium`. Allowed values [`Standard`, `Premium`]. Standard SKU is recommended for dev/test environments to reduce costs. |
