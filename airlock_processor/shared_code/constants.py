...
# SB Offloading
SERVICE_BUS_MESSAGES_STORAGE_ACCOUNT_NAME = os.environ.get("SERVICE_BUS_MESSAGES_STORAGE_ACCOUNT_NAME", "")
SERVICE_BUS_MESSAGES_CONTAINER_NAME = os.environ.get("SERVICE_BUS_MESSAGES_CONTAINER_NAME", "sb-messages")
STORAGE_ENDPOINT_SUFFIX = os.environ.get("STORAGE_ENDPOINT_SUFFIX", "core.windows.net")
SERVICE_BUS_MESSAGE_OFFLOAD_THRESHOLD = int(os.environ.get("SERVICE_BUS_MESSAGE_OFFLOAD_THRESHOLD", "200000"))
